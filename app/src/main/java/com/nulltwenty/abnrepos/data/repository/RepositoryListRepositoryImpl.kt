...
class RepositoryListRepositoryImpl @Inject constructor(
    ...
    override suspend fun fetchRepositoryList(): ResultOf<List<RepositoryListResponseElement>> =
        withContext(ioCoroutineDispatcher) {
            when (val apiResponse = safeApiCall { requestRepositoryList() }) {
                ...
                is ResultOf.Success -> return@withContext ResultOf.Success(apiResponse.data)
            }
        }
